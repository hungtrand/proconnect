				...
				<div class= "panel-body">
						<form class="form-forgot form" id="ForgotPasswordForm" action="php/ForgotPasswordEmail.php" novalidate>
						   ...
						   <!--<label class="text-info"></label>--> 
							 <label for="confirm">Please enter your email <br/> to reset password</label>
							...
							<div class="form-group">
								<button class="btn btn-lg btn-info btn-block" id="continue-btn" type="submit">Continue</button>
							</div>
