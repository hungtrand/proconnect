...
*/
class Lookup_JobFunctions extends ViewRecordSet {
	protected $TableName;
	...
	function __construct() {
		$this->PrimaryKey = 'JOBFUNCTIONID';
		$this->TableName = 'Lookup_JobFunctions';
		$this->Columns = ['JOBFUNCTIONID', 'JOBFUNCTION'];
