...
/**
*	MessageManager - performs logic for MessageManager class. This class extend Record class. It will return information from the Message table base on user id input.
*	@params: $USERID
