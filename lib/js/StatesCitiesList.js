...
function StatesCitiesList() {
	...
	this.StatesSelect = $('<select name="state-name" class="StatesList form-control select-inline">');
	this.CitiesSelect = $('<select name="city-name" class="CitiesList form-control select-inline">');
	this.states_json;
	this.cities_json;
...
StatesCitiesList.prototype = {
	...
	cities_view: function() {
		...
		that.CitiesSelect.append('<option selected>Select City</option>');
